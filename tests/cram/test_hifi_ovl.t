...
Converts the input FASTA file into a SeqDB, computes the seeds using SeedDB, and then runs overlapping.
  ...
  > ${BIN_DIR}/pancake ovl-hifi --num-threads 1 reads reads 0 0 0 | grep "^m64030_190330_071939/101844710/ccs" | cut -d ' ' -f 1-13
...
Converts the input FASTA file into a SeqDB, computes the seeds using SeedDB, and then runs overlapping.
  ...
  > ${BIN_DIR}/pancake seeddb reads.seqdb reads
  > ${BIN_DIR}/pancake ovl-hifi --num-threads 1 reads reads 0 0 0 | grep "^m64030_190330_071939/101909220/ccs" | cut -d ' ' -f 1-13
...
Converts the input FASTA file into a SeqDB, computes the seeds using SeedDB, and then runs overlapping.
  ...
  > ${BIN_DIR}/pancake seeddb reads.seqdb reads
  > ${BIN_DIR}/pancake ovl-hifi --num-threads 1 reads reads 0 0 0 | grep "^m64030_190330_071939/102303370/ccs" | cut -d ' ' -f 1-13
...
Converts the input FASTA file into a SeqDB, computes the seeds using SeedDB, and then runs overlapping.
  ...
  > ${BIN_DIR}/pancake seeddb reads.seqdb reads
  > ${BIN_DIR}/pancake ovl-hifi --num-threads 1 reads reads 0 0 0 | grep "^m64030_190330_071939/102172020/ccs" | cut -d ' ' -f 1-13
...
Converts the input FASTA file into a SeqDB, computes the seeds using SeedDB, and then runs overlapping.
  ...
  > ${BIN_DIR}/pancake seeddb reads.seqdb reads
  > ${BIN_DIR}/pancake ovl-hifi --num-threads 1 reads reads 0 0 0 | cut -d ' ' -f 1-13
...
Converts the input FASTA file into a SeqDB, computes the seeds using SeedDB, and then runs overlapping.
  ...
  > ${BIN_DIR}/pancake seeddb reads.seqdb reads
  > ${BIN_DIR}/pancake ovl-hifi --num-threads 1 --min-idt 96 reads reads 0 0 0 | cut -d ' ' -f 1-13
...
Internal overlap.
  ...
  > ${BIN_DIR}/pancake seeddb reads.seqdb reads
  > ${BIN_DIR}/pancake ovl-hifi --num-threads 1 --min-idt 94.0 reads reads 0 0 0 | grep "^m64030_190330_071939/101451080/ccs" | cut -d ' ' -f 1-13
...
This input consists of a single dovetail overlap. By default, both arcs should be output.
  $ ${BIN_DIR}/pancake seqdb reads ${PROJECT_DIR}/test-data/hifi-ovl/reads.pile10-single-ovl.fasta
  > ${BIN_DIR}/pancake seeddb reads.seqdb reads
  > ${BIN_DIR}/pancake ovl-hifi --num-threads 1 --skip-sym reads reads 0 0 0 | cut -d ' ' -f 1-13
  m64030_190330_071939/60686570/ccs m64030_190330_071939/101844710/ccs -9052 99.72 0 981 10059 10059 0 0 9077 11811 3
...
actually computed. Order may change though.
  $ ${BIN_DIR}/pancake seqdb reads ${PROJECT_DIR}/test-data/hifi-ovl/reads.pile10-single-ovl.fasta
  > ${BIN_DIR}/pancake seeddb reads.seqdb reads
  > ${BIN_DIR}/pancake ovl-hifi --num-threads 1 --skip-sym --write-rev reads reads 0 0 0 | cut -d ' ' -f 1-13
  m64030_190330_071939/60686570/ccs m64030_190330_071939/101844710/ccs -9052 99.72 0 981 10059 10059 0 0 9077 11811 3
  m64030_190330_071939/101844710/ccs m64030_190330_071939/60686570/ccs -9052 99.72 0 0 9077 11811 0 981 10059 10059 5
##################################################################
...
Test writing IDs instead of headers. Other than that, the same as the Perfect match overlap test.
  $ ${BIN_DIR}/pancake seqdb reads ${PROJECT_DIR}/test-data/hifi-ovl/reads.pile5-perfect-ovl.fasta
  > ${BIN_DIR}/pancake seeddb reads.seqdb reads
  > ${BIN_DIR}/pancake ovl-hifi --num-threads 1 --write-ids reads reads 0 0 0 | cut -d ' ' -f 1-13
...
Bestn testing on a set of perfect matching overlaps. Value "0" should deactivate the filter.
  $ ${BIN_DIR}/pancake seqdb reads ${PROJECT_DIR}/test-data/hifi-ovl/reads.pile5-perfect-ovl.fasta
  > ${BIN_DIR}/pancake seeddb reads.seqdb reads
  > ${BIN_DIR}/pancake ovl-hifi --num-threads 1 --bestn 0 reads reads 0 0 0 | cut -d ' ' -f 1-13
  m64030_190330_071939/101844710/ccs fake_read/1/ccs -5000 100.00 0 0 5000 11811 0 10000 15000 15000 5
  m64030_190330_071939/101844710/ccs fake_read/1/ccs-inverted_0-15000 -5000 100.00 0 0 5000 11811 1 0 5000 15000 5
  fake_read/1/ccs fake_read/1/ccs-inverted_0-15000 -15000 100.00 0 0 15000 15000 1 0 15000 15000 contained
  fake_read/1/ccs m64030_190330_071939/101844710/ccs -5000 100.00 0 10000 15000 15000 0 0 5000 11811 3
...
Bestn testing on a set of perfect matching overlaps. Value < "0" should deactivate the filter.
  $ ${BIN_DIR}/pancake seqdb reads ${PROJECT_DIR}/test-data/hifi-ovl/reads.pile5-perfect-ovl.fasta
  > ${BIN_DIR}/pancake seeddb reads.seqdb reads
  > ${BIN_DIR}/pancake ovl-hifi --num-threads 1 --bestn -1 reads reads 0 0 0 | cut -d ' ' -f 1-13
  m64030_190330_071939/101844710/ccs fake_read/1/ccs -5000 100.00 0 0 5000 11811 0 10000 15000 15000 5
  m64030_190330_071939/101844710/ccs fake_read/1/ccs-inverted_0-15000 -5000 100.00 0 0 5000 11811 1 0 5000 15000 5
  fake_read/1/ccs fake_read/1/ccs-inverted_0-15000 -15000 100.00 0 0 15000 15000 1 0 15000 15000 contained
  fake_read/1/ccs m64030_190330_071939/101844710/ccs -5000 100.00 0 10000 15000 15000 0 0 5000 11811 3
...
Bestn testing on a set of perfect matching overlaps. A large positive value, to test for potential edge cases.
  $ ${BIN_DIR}/pancake seqdb reads ${PROJECT_DIR}/test-data/hifi-ovl/reads.pile5-perfect-ovl.fasta
  > ${BIN_DIR}/pancake seeddb reads.seqdb reads
  > ${BIN_DIR}/pancake ovl-hifi --num-threads 1 --bestn 10 reads reads 0 0 0 | cut -d ' ' -f 1-13
  m64030_190330_071939/101844710/ccs fake_read/1/ccs -5000 100.00 0 0 5000 11811 0 10000 15000 15000 5
  m64030_190330_071939/101844710/ccs fake_read/1/ccs-inverted_0-15000 -5000 100.00 0 0 5000 11811 1 0 5000 15000 5
  fake_read/1/ccs fake_read/1/ccs-inverted_0-15000 -15000 100.00 0 0 15000 15000 1 0 15000 15000 contained
  fake_read/1/ccs m64030_190330_071939/101844710/ccs -5000 100.00 0 10000 15000 15000 0 0 5000 11811 3
...
Converts the input FASTA file into a SeqDB, computes the seeds using SeedDB, and then runs overlapping.
  $ ${BIN_DIR}/pancake seqdb reads ${PROJECT_DIR}/test-data/hifi-ovl/reads.pile3-fwd.fasta
  > ${BIN_DIR}/pancake seeddb reads.seqdb reads
  > ${BIN_DIR}/pancake ovl-hifi --num-threads 1 reads reads 0 0 0 --traceback | grep "^m64030_190330_071939/102303370/ccs" | cut -d ' ' -f 1-13
...
Converts the input FASTA file into a SeqDB, computes the seeds using SeedDB, and then runs overlapping.
  $ ${BIN_DIR}/pancake seqdb reads ${PROJECT_DIR}/test-data/hifi-ovl/reads.pile4-rev.fasta
  > ${BIN_DIR}/pancake seeddb reads.seqdb reads
  > ${BIN_DIR}/pancake ovl-hifi --num-threads 1 reads reads 0 0 0 --traceback | grep "^m64030_190330_071939/102172020/ccs" | cut -d ' ' -f 1-13
...
settings need to be modified below.
  ...
  > ${BIN_DIR}/pancake ovl-hifi --num-threads 1 reads reads 0 0 0 --traceback --use-hpc --min-map-len 0 --min-anchor-span 100 | grep "^m64030_190330_071939/102303370/ccs" | cut -d ' ' -f 1-13
...
settings need to be modified below.
  $ ${BIN_DIR}/pancake seqdb reads ${PROJECT_DIR}/test-data/hifi-ovl/reads.pile4-rev.fasta
  > ${BIN_DIR}/pancake seeddb --use-hpc reads.seqdb reads
  > ${BIN_DIR}/pancake ovl-hifi --num-threads 1 reads reads 0 0 0 --traceback --use-hpc --min-map-len 0 --min-anchor-span 100 | grep "^m64030_190330_071939/102172020/ccs" | cut -d ' ' -f 1-13
...
settings need to be modified below.
  ...
  m64030_190330_071939/102303370/ccs m64030_190330_071939/108135170/ccs -5142 99.90 0 0 5145 6298 0 496 5640 5640 5 * 221=1D649=1D296=1I169=1I167=1I3640= * u
  m64030_190330_071939/102303370/ccs m64030_190330_071939/109642940/ccs -5026 99.98 0 0 5026 6298 0 1470 6497 6497 5 * 5026=1D * u
  m64030_190330_071939/102303370/ccs m64030_190330_071939/106038710/ccs -5008 100.00 0 1290 6298 6298 0 0 5008 6585 3 * 5008= * u
  m64030_190330_071939/102303370/ccs m64030_190330_071939/114034050/ccs -1288 100.00 0 0 1288 6298 0 5263 6551 6551 5 * 1288= * u
  m64030_190330_071939/102303370/ccs m64030_190330_071939/10946880/ccs -952 100.00 0 5346 6298 6298 0 0 952 6699 3 * 952= * u
...
settings need to be modified below.
  $ ${BIN_DIR}/pancake seqdb reads ${PROJECT_DIR}/test-data/hifi-ovl/reads.pile3-fwd.fasta
  > ${BIN_DIR}/pancake seeddb --use-hpc reads.seqdb reads
  > ${BIN_DIR}/pancake ovl-hifi --num-threads 1 reads reads 0 0 0 --traceback --no-indels --use-hpc --min-map-len 0 --min-anchor-span 100 --write-cigar | grep "^m64030_190330_071939/102303370/ccs"
  m64030_190330_071939/102303370/ccs m64030_190330_071939/108135170/ccs -5142 100.00 0 0 5145 6298 0 496 5640 5640 5 * 221=1D649=1D296=1I169=1I167=1I3640= * u
  m64030_190330_071939/102303370/ccs m64030_190330_071939/109642940/ccs -5026 100.00 0 0 5026 6298 0 1470 6497 6497 5 * 5026=1D * u
  m64030_190330_071939/102303370/ccs m64030_190330_071939/106038710/ccs -5008 100.00 0 1290 6298 6298 0 0 5008 6585 3 * 5008= * u
  m64030_190330_071939/102303370/ccs m64030_190330_071939/114034050/ccs -1288 100.00 0 0 1288 6298 0 5263 6551 6551 5 * 1288= * u
  m64030_190330_071939/102303370/ccs m64030_190330_071939/10946880/ccs -952 100.00 0 5346 6298 6298 0 0 952 6699 3 * 952= * u
...
mistake them for an indel combination with interspersed matching bases.
  ...
  m64030_190330_071939/101844710/ccs fake_read_with_3_snps/1/ccs -4997 99.92 0 0 5000 11811 0 10000 15000 15000 5 * 3000=1D1=1I998=1D1=1I897=1X100= * u
  fake_read_with_3_snps/1/ccs m64030_190330_071939/101844710/ccs -4997 99.92 0 10000 15000 15000 0 0 5000 11811 3 * 3000=1I1=1D998=1I1=1D897=1X100= * u
...
mistake them for an indel combination with interspersed matching bases.
  $ ${BIN_DIR}/pancake seqdb reads ${PROJECT_DIR}/test-data/hifi-ovl/reads.pile11-3_mismatches.fasta
  > ${BIN_DIR}/pancake seeddb reads.seqdb reads
  > ${BIN_DIR}/pancake ovl-hifi --num-threads 1 reads reads 0 0 0 --traceback --min-map-len 0 --min-anchor-span 100 --write-cigar --no-indels
  m64030_190330_071939/101844710/ccs fake_read_with_3_snps/1/ccs -4997 99.98 0 0 5000 11811 0 10000 15000 15000 5 * 3000=1D1=1I998=1D1=1I897=1X100= * u
  fake_read_with_3_snps/1/ccs m64030_190330_071939/101844710/ccs -4997 99.98 0 10000 15000 15000 0 0 5000 11811 3 * 3000=1I1=1D998=1I1=1D897=1X100= * u
