...
TEST(Ses2DistanceBanded, SesDistanceBanded_EmptyQueryEmptyTarget)
{
    // Inputs.
    std::string query = "";
    std::string target = "";
    ...
    // Run.
    PacBio::Pancake::Alignment::SesResults result = PacBio::Pancake::Alignment::SES2DistanceBanded(
...
TEST(Ses2DistanceBanded, SesDistanceBanded_EmptyQueryNonemptyTarget)
{
    // Inputs.
    std::string query = "";
...
TEST(Ses2DistanceBanded, SesDistanceBanded_NonEmptyQueryEmptyTarget)
{
    // Inputs.
...
TEST(Ses2DistanceBanded, SesDistanceBanded_SimpleExactMatch)
{
    // Inputs.
    std::string query = "ACTG";
    std::string target = "ACTG";
...
TEST(Ses2DistanceBanded, SesDistanceBanded_SimpleSingleDiff)
{
    // Inputs.
...
TEST(Ses2DistanceBanded, SesDistanceBanded_SimpleTwoDiffs)
{
    // Inputs.
...
TEST(Ses2DistanceBanded, SesDistanceBanded_NormalSmallCase)
{
    /*
...
TEST(Ses2DistanceBanded, SesDistanceBanded_OutOfBandwidth)
{
    /*
     * Note: Mismatches count as 2 diffs.
    */
...
TEST(Ses2DistanceBanded, SesDistanceBanded_AboveMaxDiffs)
{
    /*
     * Note: Mismatches count as 2 diffs.
    */
